...
int isInsideButton(int x, int y,SDL_Rect buttonRect) {
  ...
  int main(int argc, char  * argv[]) {
    ...
    SDL_Surface* backgroundImage = IMG_Load("bg_purple.png"); // Replace with your image path
    if (!backgroundImage) {
    ...
    // Load a font
    TTF_Font *font = TTF_OpenFont("Terminal.ttf", 36);
    TTF_Font *font2 = TTF_OpenFont("Terminal.ttf", 24);
    if (!font) {
